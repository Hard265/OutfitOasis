...
export default observer(() => {
  ...
  return (
    <>
        ...
        <View>
          <View className="flex-row items-center justify-between p-4">
            ...
            <Text className="dark:text-white font-semibold text-lg">
              {formatCurreny(cartStore.totalPrice)}
            </Text>
          </View>
          <View className="flex-row items-center justify-between p-4">
            <Text className="dark:text-white  text-lg">Shipping</Text>
            <Text className="dark:text-white font-semibold text-lg">
              {formatCurreny(cartStore.shippingPrice)}
            </Text>
          </View>
          <View className="flex-row items-center justify-between p-4">
            <Text className="dark:text-white text-lg">Total</Text>
            <Text className="dark:text-white font-semibold text-lg">
              {formatCurreny(cartStore.totalPrice + cartStore.shippingPrice)}
            </Text>
          </View>
        </View>
        <View className="p-4">
      ...
      <Tabs.Screen
        options={{
          tabBarBadge: cartStore.totalItems
        }}
      />
    </>
  )
